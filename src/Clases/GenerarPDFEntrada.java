 ...
 * @author LENOVO
 */
public class GenerarPDFEntrada {
    ...
    public void crearPdf(String numFact,String codigoP, String descripcion, Integer cantidad, Integer precioU, int identify ) {
        ...
        try {
            ...
            File file = new File("C:\\System-inventory\\Reporte-pdf\\reporte-entrada-" +numFact+"-"+ fec + ".pdf");
            ...
            fech.add("Recibo Entrada Nº: " + numFact + "\n" + "Fecha: " + new SimpleDateFormat("dd/MM/yyyy").format(date) + "\n\n");
            ...
            cli.add("Datos Generales del proveedor " + "\n\n");
            ...
            Object[] datosCli = entrada.getProveedor(identify);
            ...
            info.add("Total Entrada: " + format2 +"\n\n");
